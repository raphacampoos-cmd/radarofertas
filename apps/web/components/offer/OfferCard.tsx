  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
        ...
        {/* Botões: Partilhar + Comprar */}
        <div style={{ display: 'grid', gridTemplateColumns: '40px 1fr', gap: '0.5rem', marginTop: 'auto' }}>
          <button
            onClick={async (e) => {
              e.preventDefault()
              const url = `https://radarofertas-psi.vercel.app/oferta/${offer.slug}`
              const text = `🔥 ${offer.title} por apenas ${formatPrice(priceCurrent)}!\n\nVer oferta:`
              ...
              if (navigator.share) {
                ...
                // Fallback para PC: copiar para clipboard
